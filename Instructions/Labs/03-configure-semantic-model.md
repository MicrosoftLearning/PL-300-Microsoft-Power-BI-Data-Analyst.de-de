...
1. Ersetzen Sie im Bereich**Eigenschaften** im Feld**Name** den Wert durch_Produkte_.
...
1. Erstellen Sie in der Tabelle`Region` eine Hierarchie namens_Regionen_ mit den folgenden drei Ebenen:
...
1. Erstellen Sie in der Tabelle`Reseller` eine Hierarchie namens_Resellers_ mit den folgenden beiden Ebenen:

     - `Business Type`
     - `Reseller`

1. Erstellen Sie eine zweite Hierarchie namens_Geography_ mit den folgenden vier Ebenen:
...
1. Legen Sie im Bereich**Eigenschaften** im Abschnitt**Formatierung** die Eigenschaft**Tausendertrennzeichen** auf_Ja_ fest.

1. Wählen Sie die Spalte`Unit Price` aus.

1. Legen Sie die Eigenschaft**Dezimalstellen** im Bereich**Eigenschaften** im Abschnitt**Formatierung** auf_2_ fest.
...
1. Legen Sie die Eigenschaft**Is Hidden** (Ist verborgen) im Bereich**Eigenschaften** auf_Ja_ fest.
...
1. Verschieben Sie im Bereich**Eigenschaften** im Abschnitt**Formatierung** den Schieberegler für die Eigenschaft**Dezimalstellen** auf_0_ (null).
...
1. Um das Measure umzubenennen, klicken Sie mit der rechten Maustaste darauf, wählen Sie**Umbenennen** aus und benennen Sie es dann in_Profit_ um.
...
1. Fügen Sie in der Tabelle`Sales` ein zweites Quickmeasure basierend auf den folgenden Anforderungen hinzu:
    ...
    - Benennen Sie das Measure in_Profit Margin_ um.
...
1. Beachten Sie, dass_Michael Blythe_ fast 9 Millionen Dollar Umsatz generiert hat.
...
1. Wählen Sie im Fenster**Beziehung bearbeiten** in der Dropdownliste**Kreuzfilterrichtung** die Option_Beide_ aus.
...
1. Ersetzen Sie im Bereich**Eigenschaften** den Text im Feld**Name** durch_Salesperson (Performance)_.
